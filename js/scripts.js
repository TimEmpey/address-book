...
function Contact(firstName, lastName, phoneNumber, emailAddress, homeAddress, mailingAddress) {
...
function handleFormSubmission(event) {
  ...
  let newContact = new Contact(inputtedFirstName, inputtedLastName, inputtedPhoneNumber, inputtedEmailAddress, inputtedHomeAddress, inputtedMailingAddress);
  ...
  document.querySelector("input#new-mailing-address").value = null;
}
